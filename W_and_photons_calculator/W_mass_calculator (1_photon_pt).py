...
out_img_fl_nm = 'muPT_distribution_1_photons'
out_meta_fl_nm = 'muPT_distribution_1_photons_metadata'
running_script_name = '"W_mass_calculator (1_photon_pt).py"'
...
condition_dat_arr = ['int((mu_truth_leading_photon_pt > 0 && mu_truth_subleading_photon_pt <= 0) || (mu_truth_leading_photon_pt <= 0 && mu_truth_subleading_photon_pt > 0))']
n_photons = [1]

hist_axis = ["lin", "lin"]  # [x, y] log: logarithmic, lin: linear
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "P_{T,#mu} distribution (1 photons)"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit (1 photons)"
