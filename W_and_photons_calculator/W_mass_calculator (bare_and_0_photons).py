...
out_img_fl_nm = 'muPT_distribution_bare_and_0_photons'
out_meta_fl_nm = 'muPT_distribution_bare_and_0_photons_metadata'
running_script_name = '"W_mass_calculator (bare_and_0_photons).py"'
...
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "P_{T,#mu} distribution (bare+0 photon)"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit (bare+0 photon)"
