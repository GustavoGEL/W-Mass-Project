...
out_img_fl_nm = 'muPT_bare_born_distribution_2_photons_herwig'
out_meta_fl_nm = 'muPT_bare_born_distribution_2_photons_herwig_metadata'
running_script_name = '"W_mass_calculator (bare_born_muon_pt_both_herwig).py"'
