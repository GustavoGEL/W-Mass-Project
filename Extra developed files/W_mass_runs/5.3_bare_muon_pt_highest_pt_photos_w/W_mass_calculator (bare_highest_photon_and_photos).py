...
out_img_fl_nm = 'muPT_distribution_1_photon_photos'
out_meta_fl_nm = 'muPT_distribution_1_photon_photos_metadata'
running_script_name = '"W_mass_calculator (bare_highest_photon_and_photos).py"'
