...
bare_muon_pt_mass = [80.51478, 80.51046, 80.52412]
bare_muon_pt_err = [0.01268, 0.01264, 0.01278]
bare_muon_pt_chi = [803.868394265728, 618.488499510048, 5272.874859197506]

ttl_lbl, x_lbl, y_lbl = "$P_{T, Bare Muon}$ and $P_{T, Born Muon}$\nW mass", "Mass (GeV)", "Case"
plot_levels_lbl = ["Reference using\nHerwig weights", "Reference using\nPhotos weights", "Reference"]
plot_fl_nam = "Bare_Born_Muon_PT_0_photons"
