...
bare_muon_pt_mass = [81.15045, 81.14313, 81.22696]
bare_muon_pt_err = [0.02181, 0.02184, 0.02115]
bare_muon_pt_chi = [327.23245649311605, 315.3815900857075, 480.2279550563655]

ttl_lbl, x_lbl, y_lbl = "$P_{T, Bare(Data)/Born(Model)Muon}$\n+$P_{T, Highest Photon}$ W mass", "Mass (GeV)", "Case"
plot_levels_lbl = ["Reference using\nHerwig weights", "Reference using\nPhotos weights", "Reference"]
plot_fl_nam = "Bare_Born_Muon_PT_1_photons"
