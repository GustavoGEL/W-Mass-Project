...
bare_muon_pt_mass = [80.50583, 80.50734, 80.51036]
bare_muon_pt_err = [0.02229, 0.02229, 0.02173]
bare_muon_pt_chi = [8.858657814354698, 8.915012030742584, 10.953005993531724]

ttl_lbl, x_lbl, y_lbl = "$P_{T, Bare Muon}+P_{T, Highest Photon}$\nW mass", "Mass (GeV)", "Case"
plot_levels_lbl = ["Reference using\nHerwig weights", "Reference using\nPhotos weights", "Reference"]
plot_fl_nam = "Bare_Muon_1_photon_PT"
