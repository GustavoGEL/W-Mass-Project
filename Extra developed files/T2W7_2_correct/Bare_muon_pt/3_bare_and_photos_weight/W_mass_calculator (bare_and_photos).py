...
out_img_fl_nm = 'muPT_distribution_0_photons_photos'
out_meta_fl_nm = 'muPT_distribution_0_photons_photos_metadata'
running_script_name = '"W_mass_calculator (bare_and_photos).py"'
...
# The following condition accounts for all events using photos weight 
condition_dat_arr = ['photos_fsr_weight']
n_photons = [0]

hist_axis = ["lin", "lin"]  # [x, y] log: logarithmic, lin: linear
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "Bare P_{T,#mu} * photos weights distribution"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit (Bare P_{T,#mu} * photos weights)"
