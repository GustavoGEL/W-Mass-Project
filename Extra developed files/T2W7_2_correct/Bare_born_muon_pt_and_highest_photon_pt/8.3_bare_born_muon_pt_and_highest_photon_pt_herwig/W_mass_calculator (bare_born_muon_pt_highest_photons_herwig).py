...
running_script_name = '"W_mass_calculator (bare_born_muon_pt_highest_photons_herwig).py"'
...
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "(Bare(Model)/Born(Data) P_{T,#mu} + P_{T,2 photons}) * herwig distribution"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit ((Bare(Model)/Born(Data) P_{T,#mu} + P_{T,2 photons}) * herwig)"
