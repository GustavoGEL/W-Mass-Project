...
out_img_fl_nm = 'muPT_bare_born_distribution_2_photons_photos'
out_meta_fl_nm = 'muPT_bare_born_distribution_2_photons_photos_metadata'
running_script_name = '"W_mass_calculator (bare_born_muon_pt_both_photons).py"'
