...
sum_fl_abs_dir_pth = r"C:\Users\gusta\Desktop\T2W8\backend\w8-w9_new_plots\Muon_pt_no_photons_regardless\InitialData"
sum_fl_nam = r"bare_pt_and_no_photons_regardless_all.txt"
...
plot_fl_nam = "FinalFigures/Bare_Muon_0_photon_PT_regardless"
...
ax2.set_xlim([min_norm_res-0.1, max_norm_res+0.1])
