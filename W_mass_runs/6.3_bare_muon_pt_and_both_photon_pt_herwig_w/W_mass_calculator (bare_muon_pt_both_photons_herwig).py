...
out_img_fl_nm = 'muPT_distribution_2_photons_herwig'
out_meta_fl_nm = 'muPT_distribution_2_photons_herwig_metadata'
running_script_name = '"W_mass_calculator (bare_muon_pt_both_photons_herwig).py"'
