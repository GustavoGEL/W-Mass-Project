...
out_img_fl_nm = 'muPT_distribution_1_photon'
out_meta_fl_nm = 'muPT_distribution_1_photon_metadata'
...
condition_dat_arr = [f'((1.0+({tree_lead_photon_pt}/{tree_fill_var}))*int(mu_truth_leading_photon_pt > 0 && mu_truth_leading_photon_pt > mu_truth_subleading_photon_pt)) + ((1.0+({tree_second_lead_photon_pt}/{tree_fill_var}))*int(mu_truth_leading_photon_pt < mu_truth_subleading_photon_pt && mu_truth_subleading_photon_pt > 0))',]
n_photons = [1]
