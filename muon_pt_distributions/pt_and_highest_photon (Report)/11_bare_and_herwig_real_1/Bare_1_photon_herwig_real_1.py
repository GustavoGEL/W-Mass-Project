...
out_img_fl_nm = 'muPT_bare_distribution_1_photon_herwig_real_1'
out_meta_fl_nm = 'muPT_bare_distribution_1_photon_hewig_real_1_metadata'
running_script_name = '"Bare_1_photon_herwig_real_1.py"'
