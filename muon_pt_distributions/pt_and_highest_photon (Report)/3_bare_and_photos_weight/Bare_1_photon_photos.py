...
out_img_fl_nm = 'muPT_bare_distribution_1_photon_photos'
out_meta_fl_nm = 'muPT_bare_distribution_1_photon_photos_metadata'
running_script_name = '"Bare_1_photon_photos.py"'
