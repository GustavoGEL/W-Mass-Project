...
out_img_fl_nm = 'muPT_born_distribution_2_photons_photos_real_1'
out_meta_fl_nm = 'muPT_born_distribution_2_photons_photos_real_1_metadata'
running_script_name = '"Born_2_photons_photos_real_1.py"'
