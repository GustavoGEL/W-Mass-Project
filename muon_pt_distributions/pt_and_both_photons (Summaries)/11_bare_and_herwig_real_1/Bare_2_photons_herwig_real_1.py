...
out_img_fl_nm = 'muPT_bare_distribution_2_photons_herwig_real_1'
out_meta_fl_nm = 'muPT_bare_distribution_2_photons_hewig_real_1_metadata'
running_script_name = '"Bare_2_photons_herwig_real_1.py"'
...
weigth_var = "herwig_fsr_weight" # Not using weights: "photos_fsr_weight", "herwig_fsr_weight"
# Define constants
