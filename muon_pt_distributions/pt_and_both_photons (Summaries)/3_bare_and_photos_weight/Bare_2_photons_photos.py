...
out_img_fl_nm = 'muPT_bare_distribution_2_photons_photos'
out_meta_fl_nm = 'muPT_bare_distribution_2_photons_photos_metadata'
running_script_name = '"Bare_2_photons_photos.py"'
