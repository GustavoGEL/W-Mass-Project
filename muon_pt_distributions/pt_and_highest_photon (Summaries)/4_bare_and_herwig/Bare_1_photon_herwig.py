...
out_img_fl_nm = 'muPT_bare_distribution_1_photon_herwig'
out_meta_fl_nm = 'muPT_bare_distribution_1_photon_herwig_metadata'
running_script_name = '"Bare_1_photon_herwig.py"'
...
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "Bare P_{T,#mu} + P_{T,1photon} herwig distribution"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit (Bare P_{T,#mu} + P_{T,1photon} herwig)"
