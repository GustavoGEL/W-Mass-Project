...
out_img_fl_nm = 'muPT_bare_distribution_1_photon_herwig_real_10'
out_meta_fl_nm = 'muPT_bare_distribution_1_photon_hewig_real_10_metadata'
running_script_name = '"Bare_1_photon_herwig_real_10.py"'
