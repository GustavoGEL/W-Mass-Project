...
out_img_fl_nm = 'muPT_born_distribution_2_photons'
out_meta_fl_nm = 'muPT_born_distribution_2_photons_metadata'
running_script_name = '"Born_2_photons.py"'
...
data_x_lbl, data_y_lbl, data_title_lbl = "muon PT [GeV]", "Normalised counts", "Born P_{T,#mu} + P_{T,2photons} distribution"
chi_square_x_lbl, chi_square_y_lbl, chi_square_title_lbl = "Hypothesis mass [GeV]", "$χ^{2}$ value", "$χ^{2}$ distribution of fits"
optim_x_lbl, optim_y_lbl, optim_title_lbl = "muon PT [GeV]", "Normalised counts", "Optimal W fit (Born P_{T,#mu} + P_{T,2photons})"
