...
bare_muon_pt_mass = [80.44711, 80.44741, 80.45272, 80.46665]
bare_muon_pt_err = [0.01173, 0.01170, 0.01175, 0.01216]
bare_muon_pt_chi = [194.18548684507186, 201.7344453479641, 235.1308339342514, 70.06269200003217]

ttl_lbl, x_lbl, y_lbl = "$P_{T, Bare Muon}$ W mass", "Mass (GeV)", "Case"
plot_levels_lbl = ["Reference using\nHerwig weights", "Reference using\nPhotos weights", "Born Muon PT", "Reference"]
plot_fl_nam = "Bare_Muon_PT_0_photons"
