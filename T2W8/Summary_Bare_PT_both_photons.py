...
bare_muon_pt_mass = [80.32844, 80.32850, 80.32817]
bare_muon_pt_err = [0.03980, 0.04025, 0.03866]
bare_muon_pt_chi = [0.009061260501986029, 0.008837746330758277, 0.009718956431017538]

ttl_lbl, x_lbl, y_lbl = "$P_{T, Bare Muon}+P_{Both Photons}$\nW mass", "Mass (GeV)", "Case"
plot_levels_lbl = ["Reference using\nHerwig weights", "Reference using\nPhotos weights", "Reference"]
plot_fl_nam = "Bare_Muon_2_photon_PT"
